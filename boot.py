...
from data_modules.constants import ESP32Pins as pins 

opin = machine.Pin(pins.GPIO14, machine.Pin.OUT, value=1, hold=False)  # Reinitialize the pin for deepsleep keypad
